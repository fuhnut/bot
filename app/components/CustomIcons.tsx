...
export const EmbedIcon = ({ className }: { className?: string }) => (
...
export const LegalIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const SparklesIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 3l1.912 3.876 4.276.621-3.094 3.016.73 4.259L12 12.764l-3.824 2.008.73-4.259-3.094-3.016 4.276-.621L12 3z" />
    </svg>
);
...
export const PaletteIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.707-.484 2.152-1.208a2.12 2.12 0 0 1 3.535-1.218 5 5 0 0 0 4.307-5.074 5 5 0 0 0-5.127-4.499c-.64.012-1.285-.152-1.848-.48a.987.987 0 0 1-.502-.857c0-.233.08-.458.226-.64A4.954 4.954 0 0 0 12 2z" />
    </svg>
);
...
export const LightbulbIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="M12 2a7 7 0 0 0-7 7c0 2.32 1.04 4.39 2.66 5.79.44.39.71.94.71 1.51V18h3.33M12 2a7 7 0 0 1 7 7c0 2.32-1.04 4.39-2.66 5.79-.44.39-.71.94-.71 1.51V18H12" />
    </svg>
);
...
export const Gamepad2Icon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const BotHeadIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
        {/* Outer Shell */}
        <path d="M4 15c0-3 0-5 1-6.5S8 6 12 6s6 .5 7 2.5 1 3.5 1 6.5s0 3-1 4.5S16 22 12 22s-6-.5-7-2.5-1-1.5-1-4.5z" />
        {/* Screen/Face Area */}
        <path d="M7 14.5c0-1.5 0-3 1-4s2.5-1 4-1 3 0 4 1 1 2.5 1 4s0 1.5-1 2.5-2.5 1-4 1-3 0-4-1-1-1-1-2.5z" fill="currentColor" fillOpacity="0.1" />
        {/* Eyes */}
        <ellipse cx="10" cy="13.5" rx="1" ry="1.5" fill="currentColor" />
        <ellipse cx="14" cy="13.5" rx="1" ry="1.5" fill="currentColor" />
        {/* Mouth */}
        <path d="M10.5 16.5c.5.5 2.5.5 3 0" strokeWidth="2" />
    </svg>
);
...
export const MentionIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ComponentIcon = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M21 16.09V7.91a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 7.91v8.18a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4a2 2 0 0 0 1-1.73z" />
